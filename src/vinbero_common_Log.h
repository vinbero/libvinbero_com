...
#define VINBERO_COMMON_LOG_TRACE(...) vinbero_common_Log_raw(VINBERO_COMMON_LOG_LEVEL_TRACE, __FILENAME__, __LINE__, __VA_ARGS__)
#define VINBERO_COMMON_LOG_TRACE2(...) VINBERO_COMMON_LOG_TRACE("in %s()", __FUNCTION__)
#define VINBERO_COMMON_LOG_DEBUG(...) vinbero_common_Log_raw(VINBERO_COMMON_LOG_LEVEL_DEBUG, __FILENAME__, __LINE__, __VA_ARGS__)
#define VINBERO_COMMON_LOG_INFO(...) vinbero_common_Log_raw(VINBERO_COMMON_LOG_LEVEL_INFO, __FILENAME__, __LINE__, __VA_ARGS__)
#define VINBERO_COMMON_LOG_WARN(...) vinbero_common_Log_raw(VINBERO_COMMON_LOG_LEVEL_WARN, __FILENAME__, __LINE__, __VA_ARGS__)
#define VINBERO_COMMON_LOG_ERROR(...) vinbero_common_Log_raw(VINBERO_COMMON_LOG_LEVEL_ERROR, __FILENAME__, __LINE__, __VA_ARGS__)
#define VINBERO_COMMON_LOG_FATAL(...) vinbero_common_Log_raw(VINBERO_COMMON_LOG_LEVEL_FATAL, __FILENAME__, __LINE__, __VA_ARGS__)
